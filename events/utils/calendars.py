...
class GenericCalendar(HTMLCalendar):
    ...
    def formatmonth(self, theyear, themonth, withyear=True, net=None, qs=None, template='calendar/month_table.html'):
...
class EventCalendar(GenericCalendar):
    ...
    def formatday(
            self, day, weekday,
            day_template='calendar/day_cell.html',
            noday_template='calendar/day_noday_cell.html',
            popover_template='calendar/popover.html',
    ):
...
class MiniEventCalendar(EventCalendar):
    ...
    def formatday(self, day, weekday):
        ...
        return super(MiniEventCalendar, self).formatday(
            day, weekday,
            day_template='calendar/mini_day_cell.html',
            popover_template='calendar/mini_popover.html',
        )
